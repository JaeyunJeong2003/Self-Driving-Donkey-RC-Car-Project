...
PI_PASSWD = "myjaecar"             # password is optional. Only used from Windows machine. Ubuntu and mac users should copy their public keys to the pi. `ssh-copy-id username@hostname`
PI_HOSTNAME = "jaecar"   # the network hostname or ip address
...
DONKEY_GYM = True
DONKEY_SIM_PATH = "C:\\Users\\jaeyu_fh3ewwy\\Desktop\\DonkeySimWindows\\DonkeySim.exe"
